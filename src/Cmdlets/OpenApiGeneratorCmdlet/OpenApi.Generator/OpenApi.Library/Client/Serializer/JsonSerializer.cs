...
namespace OpenApi.Library.Client.Serializer;
using Extensions;
...
public class JsonSerializer : ISerializer
{
    ...
    {
        var jsonSerializerOptions = new JsonSerializerOptions { DefaultIgnoreCondition = JsonIgnoreCondition.WhenWritingNull, Converters = { new JsonStringEnumConverter() } };
