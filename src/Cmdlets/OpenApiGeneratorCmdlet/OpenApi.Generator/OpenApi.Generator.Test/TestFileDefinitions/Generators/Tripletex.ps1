...
try
{
    ...
    $swagger = Invoke-WebRequest -Uri "https://api.tripletex.io/v2/swagger.json" -Headers @{"Accept"="application/json,*/*"; "Accept-Encoding"="gzip, deflate, br"} -ContentType "application/json" -UseBasicParsing
    ...
    if($swaggerJson.openapi -lt "3")
    {
        ...
        #$swaggerJson20 |Format-Json | Out-File ../swaggerTripletex20.0.json -Encoding ASCII -Force
...
"Save documentation..."
$swaggerJson30 |Format-Json | Out-File ../openApiTripletex30.json -Encoding ASCII -Force
